...
##RESERVA HABITACION
    ...
    def InsertarReservaHabitacion(self, desde, hasta, check_in, chek_out, terminada, llave_entregada, confirmada, pago, pago_realizado, cancelada, ID_huesped, ID_habitacion, ID_formareserva):
        self.cursor.execute(
            ...
            (desde, hasta, check_in, chek_out, terminada, llave_entregada, confirmada, pago, pago_realizado, cancelada, ID_huesped, ID_habitacion, ID_formareserva))
        self.conexion.commit()
    ...
    def EditarReservaHabitacion(self, id, desde, hasta, check_in, chek_out, terminada, llave_entregada, confirmada, pago, pago_realizado, cancelada, ID_huesped, ID_habitacion, ID_formareserva):
        self.cursor.execute(
            ...
            (desde, hasta, check_in, chek_out, terminada, llave_entregada, confirmada, ID_huesped, pago, pago_realizado, cancelada, ID_habitacion, ID_formareserva, id))
        self.conexion.commit()
...
##falta filtro de las actvidades
    ...
    def InsertarReservaActividad(self, fecha, hora_ingreso, hora_salida, confirmada, cancelada, disponible, pago_realizado, ID_actividad, ID_huesped, ID_forma_reserva):
        self.cursor.execute(
            ...
            (fecha, hora_ingreso, hora_salida, confirmada, cancelada, disponible, pago_realizado,  ID_actividad, ID_huesped, ID_forma_reserva))
        self.conexion.commit()
    ...
    def EditarReservaActividad(self, id, fecha, hora_ingreso, hora_salida, confirmada, cancelada, disponible, pago_realizado, ID_actividad, ID_huesped, ID_forma_reserva):
        self.cursor.execute(
            ...
            (fecha, hora_ingreso, hora_salida, confirmada, cancelada, disponible, pago_realizado, ID_actividad, ID_huesped, ID_forma_reserva, id))
        self.conexion.commit()
